(function(){
  ...
  var CRITERIA = {
    ...
    urban: 'Каналы, где город — предмет разбора, а не фон: транспорт, застройка, общественные пространства, архитектура, городское управление; без риелторского/ремонтного контента и туристических прогулок без разбора устройства города (это тревел); топ — по медиане просмотров за 184 дня.',
